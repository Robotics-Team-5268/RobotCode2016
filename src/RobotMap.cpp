...
std::shared_ptr<CANTalon> RobotMap::fetcherSpeedController1;
std::shared_ptr<Talon> RobotMap::fetcherSpeedController2;
void RobotMap::init() {
    ...
    driveGyro->Calibrate();
    shooterSpeedController.reset(new CANTalon(0));
    fetcherSpeedController1.reset(new CANTalon(0));
    fetcherSpeedController2.reset(new Talon(0));
